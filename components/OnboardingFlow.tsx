...
const profileQuestions: ProfileQuestionConfig[] = [
  {
    key: "ageRange",
    eyebrow: "ABOUT YOU",
    optiSpeech: "Let's get to know you a bit. This helps me speak to your season of life.",
  ...
  },
  {
    key: "hasChildren",
    eyebrow: "FAMILY",
    optiSpeech: "This helps me personalize the practices that matter most to you.",
  ...
  },
  {
    ...
    optiSpeech: "Your work is a big part of how you steward your days.",
  ...
  },
  {
    ...
    eyebrow: "BE HONEST",
    optiSpeech: "This stays completely private. It helps me know what you might want to bring before God.",
