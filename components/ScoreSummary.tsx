...
export function ScoreSummary({ summary }: ScoreSummaryProps) {
  return (
    <motion.section
      layout
      className="rounded-[2.25rem] border border-white/10 bg-gradient-to-br from-white/[0.14] via-white/[0.07] to-white/[0.03] p-6 shadow-2xl shadow-black/30"
    >
