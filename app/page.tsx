    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#07070a] text-white">
        <div className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.34em] text-emerald-200/60">
            Óptima
          </p>
          <p className="mt-3 text-sm text-white/45">Preparing your check-in...</p>
        </div>
      </main>
    );
  }
        ...
        <header className="mb-5 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-white/45">
              A compassionate mirror for today.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-full border border-white/10 bg-white/[0.06] px-3 py-2 text-xs text-white/45 transition hover:text-white"
            >
              Reset onboarding
            </button>
          ...
          {activeTab === "home" ? (
            <>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <StatCard
                  label="Rating"
                  value={summary.rating.label}
                  helper="Based on the 0–100 daily score."
                />
              </div>
                    ...
                    <div key={categoryScore.category}>
                      ...
                      <div className="h-2 rounded-full bg-white/10">
                        <div
                          ...
                          style={{
                            width: `${categoryScore.completionRate}%`,
                          }}
                        />
                      </div>
                    </div>
              ...
              <ReflectionCard title="Today’s reflection" eyebrow="Gentle prompt">
                <p className="text-sm leading-6 text-white/60">
                  What is one thing your day is asking you to notice without
          ...
          {activeTab === "history" ? (
            <ReflectionCard title="Weekly rhythm" eyebrow="History">
              <p className="mb-4 text-sm leading-6 text-white/58">
                A soft look at recent days — not a verdict, just a pattern you
                can learn from.
              </p>
